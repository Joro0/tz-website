...
function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-background-0 shadow-md z-50 border-b-1 border-image/40">
      <div className="container mx-auto flex items-center justify-between">
        {/* Left: Logo */}
        <div className="flex flex-row py-2 px-4 gap-2 border-r-1 border-image/40">
          <LogoTz className="w-9" />
          <div>
            <p className="text-sm text-image">TRANSPORTES</p>
            <p className="text-sm text-image">ZUÑIGA S.R.L.</p>
          </div>
        </div>
